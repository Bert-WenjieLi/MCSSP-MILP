...
#for k in range(1,TCpoint):
#    co.addConstr(quicksum(DeSu[s,j,i,k] for  i in range(1,Spoint) for j in range(1,Dpoint)for s in range(1,Sequence)) ==quicksum(SuDe[s,i,j,m,k]for s in range(1,Sequence) for  i in range(1,Spoint) for j in range(1,Dpoint) for m in range(1,MaNum)))
